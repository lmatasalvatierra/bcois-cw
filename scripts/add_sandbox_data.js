...
module.exports = async function(callback) {
    ...
    try {
        await manager.createOwner(web3.fromAscii("Test1@Owner.com"), "admin", web3.fromAscii("Luis Miguel"), web3.fromAscii("Alcala 21"));
        ...
        await manager.createPolicy(web3.fromAscii("Test1@Owner.com"), web3.fromAscii("Workers Compensation"), timeNow, oneYearFromNow, 2);
        await manager.createPolicy(web3.fromAscii("Test1@Owner.com"), web3.fromAscii("Business Owners Policy"), timeNow, oneYearFromNow, 2);
